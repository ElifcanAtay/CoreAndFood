...
namespace CoreAndFood.Controllers
{
    ...
    public class ChartController : Controller
    {
        ...
        public IActionResult Statistics()
        {
            ...
            var foodId = c.Categories.Where(x => x.CategoryName == "Meyveler").
                Select(y => y.CategoryId).FirstOrDefault();
            var deger3 = c.Foods.Where(x => x.CategoryId == foodId).Count();
            ViewBag.d3 = deger3;

            var vegetableId = c.Categories.Where(z => z.CategoryName == "Sebzeler").
                Select(y => y.CategoryId).FirstOrDefault();
            ...
            var deger6 = c.Foods.Where(x=>x.CategoryId==c.Categories.Where(y=>y.CategoryName=="Bakliyatlar").Select(z=>z.CategoryId).FirstOrDefault()).Count();
            ViewBag.d6 = deger6;
            ...
            var deger10 = c.Foods.Where(x => x.CategoryId == vegetableId).Sum(y => y.Stock);
            ViewBag.d10 = deger10;

            var deger11 = c.Foods.Where(x => x.CategoryId == foodId).Sum(y => y.Stock);
            ViewBag.d11 = deger11;
